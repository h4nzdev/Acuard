          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button variant="link" className="h-auto p-0 text-xs text-primary">Forgot password?</Button>
              </div>
              <div className="relative">
            ...
            >
              {isLoading ? (
                ...
                <>
                  {role === 'instructor' ? <User className="w-5 h-5" /> : <GraduationCap className="w-5 h-5" />}
            ...
            <div className="relative pt-4">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest">
                <span className="bg-white px-3 text-muted-foreground">Portal Selection</span>
              </div>
            </div>
            ...
            <Button 
              ...
              onClick={() => {
                setEmail("")
                setPassword("")
                router.push(`/login?role=${role === 'instructor' ? 'student' : 'instructor'}`)
              }}
              disabled={isLoading}
            >
              Switch to {role === 'instructor' ? 'Student' : 'Instructor'} Portal
            </Button>
          </div>
        </CardContent>
      </Card>
